...
#define FRONT_PANEL_MODE        1000
#define BACK_PANEL_MODE          1001
#define MIRROR_PANEL_MODE     1002
#define SWAP_PANEL_MODE          1003
/*
...
/* log macro */
#define ts_info(fmt, arg...)	pr_info("[GTP-INF front][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define	ts_err(fmt, arg...)		pr_err("[GTP-ERR front][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define boot_log(fmt, arg...)	g_info(fmt, ##arg)
#ifdef CONFIG_GOODIX_DEBUG
#define ts_debug(fmt, arg...)	pr_info("[GTP-DBG front][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#else
