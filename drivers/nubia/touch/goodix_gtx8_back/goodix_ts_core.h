...
/* log macro */
#define ts_info(fmt, arg...)	pr_info("[GTP-INF back][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define	ts_err(fmt, arg...)		pr_err("[GTP-ERR back][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#define boot_log(fmt, arg...)	g_info(fmt, ##arg)
#ifdef CONFIG_GOODIX_DEBUG
#define ts_debug(fmt, arg...)	pr_info("[GTP-DBG back][%s:%d] "fmt"\n", __func__, __LINE__, ##arg)
#else
